...
class Node {
    ...
    resetCosts() {
        if (finish.x - this.x < finish.y - this.y) {
            this.Hcost = (finish.x - this.x) * 14 + (finish.y - this.y - (finish.x - this.x)) * 10;
        } else {
            this.Hcost = (finish.y - this.y) * 14 + (finish.x - this.x - (finish.y - this.y)) * 10;
        }
        this.Gcost = null;
        this.Fcost = null;
    }
